...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{5}{|Y}|}
				\hline
				\multirow{2}{*}{\textbf{Voltage}} & \multirow{2}{*}{\textbf{Current}}  & \multicolumn{2}{ c|}{\multirow{2}{*}{\textbf{Observed Current}}}  & \multicolumn{2}{ c|}{\textbf{Front Panel LEDs On,}}\\
				& & \multicolumn{2}{ c|}{ } & \multicolumn{2}{ c|}{\textbf{$\pm$15V and $\pm$12V?}}\\ \hline
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
				\hline
				\textbf{Pins} & \textbf{Voltage Expected} & \multicolumn{2}{ c|}{\textbf{Voltage Observed}}\\ \hline
				& & OFS1 & OFS2 \\ \hline
	...
	\begin{enumerate}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
				\hline
				\textbf{Output} & \textbf{Expected} & \multicolumn{2}{ c|}{\textbf{Observed}}\\ \hline
				& & OFS1 & OFS2 \\ \hline 
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				\hline
				\textbf{Input} & \textbf{Output} & \textbf{Expected} & \multicolumn{2}{ c|}{\textbf{Observed}}\\ \hline
				& & & OFS1 & OFS2 \\ \hline
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				\hline
				\textbf{Input signal level} & \textbf{Input Gain Level} & \multirow{3}{*}{\textbf{Expected Output}} & \multicolumn{2}{ c|}{\multirow{3}{*}{\textbf{Observed Output}}}\\ 
				\textbf{“From PCal PD” }& \textbf{“To/From PCal Interface”} & & \multicolumn{2}{ c|}{ }\\
				\textbf{1(+) and 6(-)} & \textbf{Pin1 and Pin 9(GND)} & & \multicolumn{2}{ c|}{ }\\ \hline
				& & & OFS1 & OFS2 \\ \hline 
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				\hline
				\textbf{Offset Input} & \textbf{Offset Expected} & \multicolumn{2}{ c|}{\textbf{Offset Observed}}\\ \hline
				& & OFS1 & OFS2 \\ \hline
				0V & 0V$\pm$ 0.2V & &\\ \hline
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				\hline
				\textbf{Input Frequency} & \textbf{Output Expected} & \multicolumn{2}{ c|}{\textbf{Output Observed}}\\ \hline
				& & OFS1 & OFS2 \\ \hline
...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{5}{|Y}|}
				\hline
				\multirow{2}{*}{\textbf{Voltage}} & \multirow{2}{*}{\textbf{Current}}  & \multicolumn{2}{ c|}{\multirow{2}{*}{\textbf{Observed Current}}}  & \multicolumn{2}{ c|}{\textbf{Front and Back Panel,}}\\
				& & \multicolumn{2}{ c|}{ } & \multicolumn{2}{ c|}{\textbf{$\pm$15V LEDs On}}\\ \hline
		...
		\begin{enumerate}
			...
			\begin{center}\
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
					\hline
					\textbf{EtherCAT Pin} & \textbf{Optical Follower Pin} & \multicolumn{2}{ c|}{\textbf{Continuous (Yes/No)?}}\\ \hline
			...
			\begin{center}
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
					\hline
					\textbf{Anti-Alias Pin} & \textbf{Optical Follower Pin} & \multicolumn{2}{ c|}{\textbf{Continuous (Yes/No)?}}\\ \hline
					& & Interface1 & Interface2 \\ \hline
			...
			\begin{center}
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
					\hline
					\textbf{EtherCAT Pin} & \textbf{Laser Power and AOM Pin} & \multicolumn{2}{ c|}{\textbf{Continuous (Yes/No)?}}\\ \hline
					& & Interface1 & Interface2 \\ \hline
			...
			\begin{center}
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
					\hline
					\textbf{EtherCAT Pin} & \textbf{WS PD Pin} & \multicolumn{2}{ c|}{\textbf{Continuous (Yes/No)?}}\\ \hline
					& & Interface1 & Interface2 \\ \hline
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{5}{|Y}|}
				\hline
				\textbf{Pin to connect with Pin 12} & \textbf{Switch positions} & \textbf{Readout pin} & \textbf{Expected signal} & \multicolumn{2}{ c|}{\textbf{Signal present (Yes/No)?}}\\ \hline
				& & & & Interface1 & Interface2 \\ \hline
				\multirow{2}{*}{“To Shutter” Pin 6} & \multirow{2}{*}{Remote} & “EtherCAT”  & +15V$\pm$0.5V,  & & \\
				& & Pin 32 & “Open” LED lit && \\ \hline 
				\multirow{2}{*}{“To Shutter” Pin 5} & \multirow{2}{*}{Remote} & “EtherCAT”  & +15V$\pm$0.5V, & &\\ 
				...
				\multirow{2}{*}{“EtherCAT” Pin 30} & Local, pushing  &“To Shutter” & \multirow{2}{*}{+15V$\pm$0.5V} & &\\
				& “Open” button & Pin 3 & & &\\ \hline
				\multirow{2}{*}{“EtherCAT” Pin 30} & Local, pushing  & “To Shutter” & \multirow{2}{*}{0V} & &\\ 
				& “Close” button & Pin 1 & & &\\
				\hline
			\end{tabularx}
		\end{center}
		...
		\begin{enumerate}
			...
			\begin{center}
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
					\hline
					\textbf{Input} & \textbf{Output Pins (Expected 0dB +/- 0.5dB)} & \multicolumn{2}{ c|}{\textbf{Observed Output}}\\ \hline
					& & Interface1 & Interface2 \\ \hline
			...
			\begin{center}
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
						\hline
						\textbf{Input} & \textbf{Output Pins (Expected 6dB +/- 0.5dB)} & \multicolumn{2}{ c|}{\textbf{Observed Output}}\\ \hline
						& & Interface1 & Interface2 \\ \hline
			...
			\begin{center}
				\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
						\hline
						\textbf{Pin} & \textbf{Expected Voltage} & \multicolumn{2}{ c|}{\textbf{Observed Voltage}}\\ \hline
						& & Interface1 & Interface2 \\ \hline
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				\hline
				\textbf{Input Pins} & \textbf{Output Pins} & \textbf{Expected Output} & \multicolumn{2}{ c|}{\textbf{Observed Output}}\\ \hline
				& & & Interface1 & Interface2 \\ \hline
...
According to the OFS electric circuit, the transfer function of OFS is:
\begin{eqnarray}
T=\frac{V_{out}}{V_{in}}=&\frac{1}{1+j\omega(5k)(20p)}\frac{G}{1+j\omega(2k)(27n)}\frac{1+j\omega(0.2k)(27n)}{1+j\omega(2.2k)(27n)}\frac{1}{3}\frac{1}{1+j\omega(5k)(20p)}\\
