	...
	\begin{enumerate}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{3}{|Y}|}
				...
				\multirow{4}{*}{“Out Mon” BNC} & -8.11dB at DC with 2 poles @ & & \\
				& 3KHz, and 1 zero @30KHz & &\\ \hline
				\multirow{2}{*}{“Out Mon” BNC} & -88.14 deg$\pm$2deg  of phase at 3KHz& &\\ \hline
				\multirow{3}{*}{“Out Mon” BNC} & Rising to -125.93deg$\pm$2deg & &\\ 
				&of phase @ 30KHz& &\\ \hline
				\multirow{4}{*}{“To AOM” BNC} & -8.11dB at DC with 2 poles @ & & \\
				& 3KHz, and 1 zero @30KHz & &\\ \hline
				\multirow{2}{*}{“To AOM” BNC} & -88.142deg$\pm$2deg of phase at 3KHz & &\\ \hline
				\multirow{3}{*}{“To AOM” BNC} & Rising to -125.93deg$\pm$2deg & &\\ 
				&of phase @ 30KHz& &\\ \hline
			\end{tabularx}
		\end{center}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				...
				& & & OFS1 & OFS2 \\ \hline
				“From DAC”  & \multirow{5}{*}{“To AOM” BNC} & -8.11dB at DC with 2 & & \\
				connector Pins & & poles @ 3KHz, and 1 & &\\
				1(+) and 6(GND) & & zero @30KHz & &\\ \hline
				\multirow{5}{*}{“CLTF Test In” BNC}  & \multirow{5}{*}{“To AOM” BNC} & -8.11dB at DC with 2 & &\\
				& & poles @ 3KHz, and 1 & &\\
				& & zero @30KHz & &\\ 
				\hline
			\end{tabularx}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{4}{|Y}|}
				...
				\multirow{4}{*}{1$\mbox{V}_{\mbox{p-p}}$}  & \multirow{4}{*}{-9.6V} & 143 $\mbox{mV}_{\mbox{p-p}}$ $\pm$ 10mV& &\\
				& &  or 55 $\mbox{mV}_{\mbox{rms}}$ $\pm$ 10mV & &\\ \hline
				\multirow{4}{*}{1$\mbox{V}_{\mbox{p-p}}$}  & \multirow{4}{*}{0V} & 4.12 $\mbox{V}_{\mbox{p-p}}$ $\pm$ 100mV& &\\
				& &  or 1.48 $\mbox{mV}_{\mbox{rms}}$ $\pm$ 10mV & &\\ \hline
				\multirow{4}{*}{0.03$\mbox{V}_{\mbox{p-p}}$}  & \multirow{4}{*}{+9.6V} & 3.72 $\mbox{mV}_{\mbox{p-p}}$ $\pm$ 10mV& &\\
	...
	\begin{enumerate}
		...
		\begin{center}
			\begin{tabularx}{\textwidth}{|c *{5}{|Y}|}
				...
				\multirow{3}{*}{“To Shutter” Pin 6} & \multirow{3}{*}{Remote} & “EtherCAT”  & +15V$\pm$0.5V,  & & \\
				& & Pin 32 & “Open” LED lit && \\ \hline 
				\multirow{3}{*}{“To Shutter” Pin 5} & \multirow{3}{*}{Remote} & “EtherCAT”  & +15V$\pm$0.5V, & &\\ 
				& & Pin 14 & “Closed” LED lit & &\\ \hline 
				\multirow{2}{*}{“Optical Follower” Pin 5} & \multirow{2}{*}{Remote} & “EtherCAT” Pin 33 & \multirow{2}{*}{+15V$\pm$0.5V} & &\\ \hline 
				\multirow{3}{*}{“EtherCAT” Pin 30} & \multirow{3}{*}{Remote} & “To Shutter” Pin 1 & \multirow{3}{*}{+15V$\pm$0.5V} & &\\ \hline 
				\multirow{3}{*}{“EtherCAT” Pin 30} & \multirow{3}{*}{Remote} & “To Shutter” Pin 3 & \multirow{3}{*}{+15V$\pm$0.5V} & &\\ \hline 
				\multirow{3}{*}{“EtherCAT” Pin 30} & \multirow{3}{*}{Local} & “To Shutter” Pin 1 & \multirow{3}{*}{+15V$\pm$0.5V} & &\\ \hline 
				\multirow{3}{*}{“EtherCAT” Pin 30} & \multirow{3}{*}{Local} & “To Shutter” Pin 3 & \multirow{3}{*}{0V} & &\\ \hline 
				\multirow{4}{*}{“EtherCAT” Pin 30} & Local, pushing  &“To Shutter” & \multirow{4}{*}{+15V$\pm$0.5V} & &\\
				& “Open” button & Pin 3 & & &\\ \hline
				\multirow{4}{*}{“EtherCAT” Pin 30} & Local, pushing  & “To Shutter” & \multirow{4}{*}{0V} & &\\ 
				& “Close” button & Pin 1 & & &\\
				\hline
			\end{tabularx}
		\end{center}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=15cm]{path1_no_lens.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=15cm]{modematching_AOM.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=15cm]{path1_with_lens.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=15cm]{path2_with_lens.eps}
...
\begin{figure}
	\begin{center}
		\includegraphics[width=15cm]{modematching_ETM.eps}
