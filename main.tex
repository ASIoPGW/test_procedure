...
\documentclass[10pt, % The default document font size, options: 10pt, 11pt, 12pt
...
\usepackage[outdir=Figures/z_]{epstopdf}
...
\thesistitle{Test Procedure of KAGRA photon calibrator in X-end} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\author{C. Kozakai, Y. \textsc{Inoue}, Y.-K. Chu, S. Haino, B. H. Hsieh, N. Kanda, T.Shishido, T. Tomaru, T. Yamamoto, and T. Yokozawa\\
...
\bibitem{ligo:injdcc} 
  A.~Mullavey {\it et al.},
  ``The Advanced LIGO Hardware Injection Infrastructure''
  [\href{https://dcc.ligo.org/LIGO-T1400349/public}{LIGO-T1400349}].
